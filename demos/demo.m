%% demo.m
%  Command-line demo of the MagAnalyst ANHYSTERETIC workflow with a single
%  component: import -> fit distribution parameters (Hcr, m(Hcr)) -> retrieve
%  magnetic parameters -> build the modeled curve -> errors/residues -> plots.
%
%  See also:
%    demo_2_components.m         - two-component anhysteretic fit
%    demo_hysteretic_playground.m - Jiles-Atherton hysteretic simulation (v2)
clc; clear; close all;
