...
%%
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.MsLower_JA.Layout.Column = 8;

            % Create MsUpper_JA
            app.MsUpper_JA = uieditfield(app.GridLayout2, 'numeric');
            ...
            app.ReltoleranceEditField_3.ValueDisplayFormat = '%.3e';
